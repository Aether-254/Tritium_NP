...
public class TritiumEmbPage extends OptionPage {
    ...
    TritiumEmbPage(String pageId, Component title, ImmutableList<OptionGroup> groups) {
        super(OptionIdentifier.create(
                        Objects.requireNonNull(ResourceLocation.tryBuild(TritiumCommon.MOD_ID, pageId))),
                title,
                groups);
    }
    ...
    public static TritiumEmbPage createServerPerformancePage() {
        return new TritiumPageBuilder("server_performance", Component.translatable("config.tritium.category.serverPerformance"))
                ...
                .addGroup("group_async_world_save", Component.translatable("config.tritium.serverPerformance.asyncWorldSave"), builder -> builder
                        .addBoolean("async_world_save",
                        ...
                        .addInteger("async_world_save_seconds",
                                "config.tritium.serverPerformance.asyncWorldSave_asyncWorldSaveTimeoutSeconds",
                                1, 60, 1,
                                v -> v > 0 ? Component.literal(v + " seconds") : CommonComponents.OPTION_OFF,
    ...
    public static TritiumEmbPage createTechOptimizationsPage() {
        return new TritiumPageBuilder("tech_optimizations", Component.translatable("config.tritium.category.techOptimizations"))
                .addGroup("group_lambdaEventListeners", Component.translatable("config.tritium.techOptimizations.lambdaEventListeners"), builder -> builder
                        .addBoolean("enable_lambdaEventListeners",
                                "config.tritium.techOptimizations.lambdaEventListeners_lambdaEventListeners",
                                (c, v) -> TritiumConfigBase.TechOptimizations.LambdaEventListeners.lambdaEventListeners = v,
                                c -> TritiumConfigBase.TechOptimizations.LambdaEventListeners.lambdaEventListeners))
