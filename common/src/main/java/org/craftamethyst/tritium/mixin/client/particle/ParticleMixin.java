...
public abstract class ParticleMixin {
    ...
    @Unique
    private BlockPos.MutableBlockPos tritium$cachedPos1 = new BlockPos.MutableBlockPos();
    @Unique
    private BlockPos.MutableBlockPos tritium$cachedPos2 = new BlockPos.MutableBlockPos();
    @Unique
    private BlockPos.MutableBlockPos tritium$cachedPos3 = new BlockPos.MutableBlockPos();
    @Unique
